...
function sendFakeFishingSkillup()
    local sid = AshitaCore:GetDataManager():GetParty():GetMemberServerId(0);
    local tid = AshitaCore:GetDataManager():GetParty():GetMemberTargetIndex(0);
    ...
    AddIncomingPacket(0x29, packet:totable());
end
